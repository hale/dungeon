...
public class FactionFollowBehaviour implements Behaviour {
  ...
  public FactionFollowBehaviour(Faction faction)
  {
  ...
  private void followLeader(Creature leader)
  {
    ...
    List<Point2D> path;
    SlaveFollowBehaviour creatureBehaviour;
    for (Creature creature : factionCreatures)
    {
      creatureBehaviour = (SlaveFollowBehaviour) creature.getBehaviour();
